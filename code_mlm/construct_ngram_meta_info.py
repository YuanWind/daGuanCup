...
def construct_ngram_meta_info(w2v_file="data/mlm_data/w2v.model",
                              ngram_words_file="data/mlm_data/ngram_words.pkl",
                              tokenizer_path="tokenizer",
                              output_meta_file="data/mlm_data/ngram_dict.pkl"):
    ngram_dict = {
